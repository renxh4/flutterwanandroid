...
ArticleListResponse _$ArticleListResponseFromJson(Map<String, dynamic> json) =>
    ArticleListResponse(
      data: json['data'] == null
          ? null
          : ArticlePage.fromJson(json['data'] as Map<String, dynamic>),
...
ArticlePage _$ArticlePageFromJson(Map<String, dynamic> json) => ArticlePage(
...
ArticleTag _$ArticleTagFromJson(Map<String, dynamic> json) => ArticleTag(
